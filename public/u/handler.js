(() => {
  ...
  function l(i) {
    if ("__uv" in i && i.__uv instanceof e) return !1;
    i.document &&
      i.window &&
      i.document
    ...
    v.nativeMethods.defineProperty(i, "__uv", { value: c, enumerable: !1 }),
    ...
    if (
      ...
      (c.localStorageObj = {}),
      (c.sessionStorageObj = {}),
      "about:srcdoc" === c.location.href && (c.meta = i.parent.__uv.meta),
      i.EventTarget &&
      ...
      v.nativeMethods.defineProperty(v.storage.storeProto, "__uv$storageObj", {
        get() {
      ...
      for (const e in i.localStorage)
        e.startsWith(u + c.location.origin + "@") &&
          (c.localStorageObj[e.slice((u + c.location.origin + "@").length)] =
    ...
    if (i.sessionStorage) {
      for (const e in i.sessionStorage)
        e.startsWith(u + c.location.origin + "@") &&
          (c.sessionStorageObj[e.slice((u + c.location.origin + "@").length)] =
    ...
    if (
      ...
      v.storage.on("length", (e) => {
        e.that.__uv$storageObj &&
          e.respondWith(
            v.nativeMethods.keys.call(null, e.that.__uv$storageObj).length,
          );
      }),
      v.storage.on("key", (e) => {
        e.that.__uv$storageObj &&
          e.respondWith(
            v.nativeMethods.keys.call(null, e.that.__uv$storageObj)[
              e.data.index
            ] || null,
          );
      }),
        ...
        (t.Origin = c.meta.url.origin),
          ...
          e.respondWith(
            m.createWebSocket(e.data.args[0], e.data.args[1], {
              headers: t,
              readyStateHook: (e, t) => {
                e.__uv$getReadyState = t;
              },
              sendErrorHook: (e, t) => {
                e.__uv$getSendError = t;
              },
              urlHook: (e, t) => {
                e.__uv$socketUrl = t;
              },
              protocolHook: (e, t) => {
                e.__uv$getProtocol = t;
              },
      ...
      v.websocket.on("readyState", (e) => {
        "__uv$getReadyState" in e.that &&
          (e.data.value = e.that.__uv$getReadyState());
      }),
      v.websocket.on("send", (e) => {
        if ("__uv$getSendError" in e.that) {
          const t = e.that.__uv$getSendError();
          if (t) throw t;
        }
      }),
      v.websocket.on("url", (e) => {
        "__uv$socketUrl" in e.that &&
          (e.data.value = e.that.__uv$socketUrl.toString());
      }),
      v.websocket.on("protocol", (e) => {
        "__uv$getProtocol" in e.that &&
          (e.data.value = e.that.__uv$getProtocol());
      }),
            ...
            if (!a.__uv$modifiedStyle)
              for (const e of v.style.urlProps)
                v.nativeMethods.defineProperty(a, e, {
                  ...
                  v.nativeMethods.defineProperty(a, "__uv$modifiedStyle", {
                    enumerable: !1,
                    value: !0,
                  });
            return a;
    ...
    v.style.on("setCssText", (e) => {
      ...
      v.location.on("hashchange", (e, t, a) => {
        if (a.HashChangeEvent && v.history.replaceState) {
          ...
          v.nativeMethods.defineProperty(r, "__uv$dispatched", {
            value: !0,
            enumerable: !1,
          }),
      ...
      v.overrideDescriptor(i, "localStorage", {
        get: (e, t) => (t || i).__uv.lsWrap,
      }),
      v.overrideDescriptor(i, "sessionStorage", {
        get: (e, t) => (t || i).__uv.ssWrap,
      }),
  ...
  self.__uv || l(self), (self.__uvHook = l);
})();
