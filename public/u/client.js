  ...
  (() => {
    ...
    const i = class extends t {
      ...
      overrideQuerySelector() {
        this.ctx.override(this.docProto, "querySelector", (t, r, i) => {
          ...
          return (
            this.emit("querySelector", s),
            s.intercepted
              ? s.returnValue
              : s.target.call(s.that, s.data.selectors)
          );
        });
      }
      overrideDomain() {
      ...
      overrideCreateTreeWalker() {
        this.ctx.override(this.docProto, "createTreeWalker", (t, r, i) => {
          ...
          const h = new e(
            { root: o, show: s, filter: n, expandEntityReferences: a },
            t,
            r,
          );
          return (
        ...
        this.ctx.override(this.docProto, "write", (t, r, i) => {
          ...
          this.ctx.override(this.docProto, "writeln", (t, r, i) => {
            ...
            return (
              ...
              s.intercepted
                ? s.returnValue
                : s.target.apply(s.that, s.data.html)
            );
          });
      }
      overrideDocumentURI() {
      ...
      overrideURL() {
        this.ctx.overrideDescriptor(this.docProto, "URL", {
          get: (t, r) => {
            const i = new e({ value: t.call(r) }, t, r);
            return (
              this.emit("url", i), i.intercepted ? i.returnValue : i.data.value
            );
          },
        });
      }
      ...
      overrideParent() {
        this.ctx.overrideDescriptor(this.nodeProto, "parentNode", {
          get: (t, r) => {
            ...
            return (
              this.emit("parentNode", i),
              i.intercepted ? i.returnValue : i.data.node
            );
          },
        }),
      ...
      overrideOwnerDocument() {
        this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
          get: (t, r) => {
            ...
            return (
              this.emit("ownerDocument", i),
              i.intercepted ? i.returnValue : i.data.document
            );
          },
        });
      }
        ...
        this.ctx.override(
          ...
          (t, r, i) => {
            ...
            return s.intercepted
              ? s.returnValue
              : s.target.call(s.that, s.data.node);
          },
        );
      }
      ...
      overrideNameValue() {
        this.ctx.overrideDescriptor(this.attrProto, "name", {
          get: (t, r) => {
            const i = new e({ value: t.call(r) }, t, r);
            return (
              this.emit("name", i), i.intercepted ? i.returnValue : i.data.value
            );
          },
        }),
    ...
    const a = class extends t {
      ...
      overrideToString() {
        this.ctx.override(this.fnProto, "toString", (t, r) => {
          ...
          return (
            this.emit("toString", i),
            i.intercepted ? i.returnValue : i.target.call(i.data.fn)
          );
        });
      }
    };
    const h = class extends t {
      ...
      overrideGetPropertyNames() {
        this.ctx.override(this.Object, "getOwnPropertyNames", (t, r, i) => {
          ...
          return (
            this.emit("getOwnPropertyNames", s),
      ...
      overrideGetOwnPropertyDescriptors() {
        this.ctx.override(
          ...
          (t, r, i) => {
            ...
            return (
              this.emit("getOwnPropertyDescriptors", s),
      ...
      overrideHeaders() {
        return (
          ...
          this.ctx.override(this.headersProto, "has", (t, r, i) => {
            ...
            return (
              this.emit("hasHeader", s), s.intercepted ? s.returnValue : s.data
            );
          }),
    ...
    const c = class extends t {
      ...
      overrideOpen() {
        this.ctx.override(this.xhrProto, "open", (t, r, i) => {
          ...
          const l = new e(
            { method: o, input: s, async: n, user: a, password: h },
            t,
            r,
          );
          return (
      ...
      overrideGetResHeaders() {
        this.ctx.override(this.xhrProto, "getAllResponseHeaders", (t, r) => {
          const i = new e({ value: t.call(r) }, t, r);
          return (
            this.emit("getAllResponseHeaders", i),
            i.intercepted ? i.returnValue : i.data.value
          );
        });
      }
    ...
    const u = class extends t {
      ...
      overridePushState() {
        this.ctx.override(this.historyProto, "pushState", (t, r, i) => {
          ...
          return (
            this.emit("pushState", a),
            a.intercepted
              ? a.returnValue
              : a.target.call(a.that, a.data.state, a.data.title, a.data.url)
          );
        });
      }
      ...
      overrideForward() {
        this.ctx.override(this.historyProto, "forward", (t, r) => {
          ...
          return (
            this.emit("forward", i),
            i.intercepted ? i.returnValue : i.target.call(i.that)
          );
        });
      }
      overrideBack() {
        ...
        return (
          "reload" in this.location &&
            this.ctx.nativeMethods.defineProperty(r, "reload", {
              value: this.ctx.wrap(this.location, "reload", (t, e) =>
                t.call(e === r ? this.location : e),
              ),
              writable: !1,
              enumerable: !0,
            }),
    ...
    const w = class extends t {
      ...
      overridePostMessage() {
        this.ctx.override(this.window, "postMessage", (t, r, i) => {
          ...
          const a = new e(
            { message: o, origin: s, transfer: n, worker: this.ctx.worker },
            t,
            r,
          );
          return (
      ...
      wrapPostMessage(t, r, i = !1) {
        return this.ctx.wrap(t, r, (r, o, s) => {
          ...
          const l = new e(
            { message: n, origin: a, transfer: h, worker: this.ctx.worker },
            r,
            t,
          );
          return (
      ...
      overrideMessageData() {
        this.ctx.overrideDescriptor(this.messageProto, "data", {
          get: (t, r) => {
            const i = new e({ value: t.call(r) }, t, r);
            return (
              this.emit("data", i), i.intercepted ? i.returnValue : i.data.value
            );
          },
        });
      }
        ...
        this.ctx.override(
          ...
          (t, r, i) => {
            ...
            return (
              ...
              n.intercepted
                ? n.returnValue
                : new n.target(...[n.data.url, n.data.options])
            );
          },
          !0,
        );
    ...
    const y = class extends t {
        ...
        this.ctx.override(this.storeProto, "getItem", (t, r, i) => {
          ...
          this.ctx.override(this.storeProto, "key", (t, r, i) => {
            ...
            return (
              ...
              s.intercepted
                ? s.returnValue
                : s.target.call(s.that, s.data.index)
            );
          });
      }
      overrideLength() {
        this.ctx.overrideDescriptor(this.storeProto, "length", {
          get: (t, r) => {
            ...
            return (
              this.emit("length", i),
              i.intercepted ? i.returnValue : i.data.length
            );
          },
        });
      }
      emulate(t, r = {}) {
        ...
        return (
          this.wrappers.set(i, t),
          this.ctx.nativeMethods.setPrototypeOf(i, this.storeProto),
          i
        );
      }
    };
      ...
      overrideSetGetProperty() {
        this.ctx.override(this.cssStyleProto, "getPropertyValue", (t, r, i) => {
          ...
          return (
            ...
            s.intercepted
              ? s.returnValue
              : s.target.call(s.that, s.data.property)
          );
        }),
    ...
    const x = class extends t {
      constructor(t) {
        super(),
          ...
          (this.protocol = t.nativeMethods.getOwnPropertyDescriptor(
            this.wsProto,
            "protocol",
          )),
          (this.readyState = t.nativeMethods.getOwnPropertyDescriptor(
            this.wsProto,
            "readyState",
          )),
    ...
    class b extends t {
      ...
      wrap(t, e, r, i = !1) {
        ...
        return (
          i && ((s.prototype = o.prototype), (s.prototype.constructor = s)),
